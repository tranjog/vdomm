...
var createVApp = function createVApp(count) {
  return (0, _createElement.default)('div', {
    ...
    children: [String(count), (0, _createElement.default)('br')].concat(_toConsumableArray(Array.from({
      length: count
    }, function () {
...
setInterval(function () {
  var vNewApp = createVApp(parseInt(Math.random() * 10));
  var patch = (0, _diff.default)(vApp, vNewApp);
  $rootEl = patch($rootEl);
  vApp = vNewApp; //document.getElementById('app').innerHTML = d.toLocaleTimeString();
}, 1000);
